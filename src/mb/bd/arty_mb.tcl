...
################################################################
# This is a generated script based on design: arty_mb
#
...
proc create_root_design { parentCell } {
  ...
  set gpio02_1_i [ create_bd_port -dir I -from 31 -to 0 gpio02_1_i ]
  set gpio02_1_o [ create_bd_port -dir O -from 31 -to 0 gpio02_1_o ]
  set gpio02_2_i [ create_bd_port -dir I -from 31 -to 0 gpio02_2_i ]
  set gpio02_2_o [ create_bd_port -dir O -from 31 -to 0 gpio02_2_o ]
  set led_4bits [ create_bd_port -dir O -from 3 -to 0 led_4bits ]
  set push_buttons_4bits [ create_bd_port -dir I -from 3 -to 0 push_buttons_4bits ]
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports led_4bits] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports sig_out] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_ports gpio02_2_o] [get_bd_pins axi_gpio_2/gpio2_io_o]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_ports gpio02_1_o] [get_bd_pins axi_gpio_2/gpio_io_o]
  ...
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports gpio02_2_i] [get_bd_pins axi_gpio_2/gpio2_io_i]
  connect_bd_net -net gpio_io_i_0_1 [get_bd_ports gpio02_1_i] [get_bd_pins axi_gpio_2/gpio_io_i]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  connect_bd_net -net push_buttons_4bits_1 [get_bd_ports push_buttons_4bits] [get_bd_pins axi_gpio_0/gpio2_io_i]
